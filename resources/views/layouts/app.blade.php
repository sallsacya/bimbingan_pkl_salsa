...
<head>
  ...
  <title>KPU KOTA BANJARMASIN</title>
...
<div class="wrapper">
  ...
  <!-- Main Header -->
  <header class="main-header" style="background-color: #fe0000">

    <!-- Logo -->
    <a href="#" class="logo" style="background-color: #fe0000">
    ...
    <!-- Header Navbar -->
    <nav class="navbar navbar-static-top" role="navigation"  style="background-color: #fe0000">
